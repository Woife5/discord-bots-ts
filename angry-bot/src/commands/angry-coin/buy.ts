import { Message, EmbedBuilder, User as DiscordUser, ChatInputCommandInteraction, ButtonInteraction, ActionRowBuilder, ButtonBuilder, ButtonStyle, Interaction, PartialGroupDMChannel, InteractionResponse, Options } from "discord.js";
...
async function regularPurchase(interaction : ChatInputCommandInteraction, user : Document & IUser | null, shopItem : ShopItem, amount : number) : Promise<InteractionResponse<boolean>>
{
...
async function censorshipPurchase(interaction : ChatInputCommandInteraction, user : Document & IUser | null, shopItem : ShopItem, message : string) : Promise<InteractionResponse<boolean>>
{
    const embed = defaultEmbed();
...
async function buyCensorship(interaction : ChatInputCommandInteraction, user : Document & IUser, price : number, censoredString : string) : Promise<InteractionResponse<boolean>>
{
    const embed = defaultEmbed();
